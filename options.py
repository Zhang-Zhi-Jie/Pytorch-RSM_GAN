...
class Options():
    ...
    def __init__(self):
        ##
        #
        self.parser = argparse.ArgumentParser(description = 'RSM-GAN')
        ##
        # Base
        ...
        self.parser.add_argument('--isize', type=int, default=30, help='input size.')
        self.parser.add_argument('--nc', type=int, default=3, help='input channels')
        ...
        self.parser.add_argument('--sensor_n', type = int, default = 30, help = 'number of sensors')
        self.parser.add_argument('--win_size', type = int, default = [10, 30, 60], help = 'window size of each segment')
        self.parser.add_argument('--step_max', type = int, default = 5, help = 'maximum step of ConvLSTM')
        # self.parser.add_argument('--train_start_id',  type = int, default = 12,
        #                         help = 'training start id')
        # self.parser.add_argument('--train_end_id',  type = int, default = 800,
        #                         help = 'training end id')
        # self.parser.add_argument('--test_start_id',  type = int, default = 800,
        #                         help = 'test start id')
        # self.parser.add_argument('--test_end_id',  type = int, default = 2000,
        #                         help = 'test end id')
        self.parser.add_argument('--save_model_step', type = int, default = 1,
                                help = 'number of iterations to save model')
        self.parser.add_argument('--model_path', type = str, default = './checkpoints/model/',
                        help='path to save models')
        self.parser.add_argument('--matrix_data_path', type = str, default = './data/matrix_data/',
                        help='matrix data path')
        self.parser.add_argument('--train_test_flag', type=int, default = 1,
